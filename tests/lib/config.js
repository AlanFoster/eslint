...
describe("Config", function() {
    ...
    describe("getConfig()", function() {
        ...
        it("should extend package configuration with sub directories", function() {
            ...
            configHelper.findLocalConfigFiles = function() {
                return [path.resolve(__dirname, "../fixtures/config-extends/package2/.eslintrc")];
            };
            ...
            actual = configHelper.getConfig(path.resolve(__dirname, "../fixtures/config-extends/package2/subdir/foo.js"));
